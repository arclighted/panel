#!/usr/bin/env node
/**
 * storage/addons/modrinth/scripts/build-ui.mjs
 *
 ...
 *
 * Run: pnpm --dir storage/addons/modrinth build:ui
 */
...
console.log(`Building modrinth v3 UI → ${join('public', 'ui', 'bundle.mjs')}`)
