/**
 * POST /admin/images/import-url — Nitro twin of the Express handler in
 * src/modules/admin/images.ts. Byte-identical (D3): fetches an egg from a
 * URL, validates, normalizes, and creates-or-updates the image row.
 */
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return { success: false, error: 'Failed to import egg from URL' }
  }
})
